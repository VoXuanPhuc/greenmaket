...
//        ApiService.apiService.getAnhNongSanTheoNongSan(listNongSan.get(position).getId()).
//                enqueue(new Callback<ArrayList<AnhNongSan>>() {
//                    ArrayList<AnhNongSan> a;
//                    @Override
//            public void onResponse(Call<ArrayList<AnhNongSan>> call, Response<ArrayList<AnhNongSan>> response) {
//                        a.clear();
//                a = response.body();
//                Picasso.with(context).load(a.get(0).getTen()).into(holder.imageNongsan);
//            }
//
//            @Override
